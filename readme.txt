...
- **On-Demand Access to Recordings:** Review and revisit your classes with ease. Access all class recordings effortlessly, making it a valuable resource for reviewing past sessions.
...
- Class Customization:
  - Class Naming: Assign meaningful names to each class.
  - Access Control: Secure your class by adding an access code.
  - Custom Presentation URL: Specify URLs for custom presentations.
  - Recording Option: Choose to enable or disable recording for each class.
  - Moderator Approval: Require moderator approval for participants joining the class.
  - Branding and Customization: Add a custom logo, welcome message, and theme color.
  - Custom Logout Page: Redirect attendees to a specific page after class.
  - Layout Options: Select from video-focused, presentation-focused, or a combination layout.
  - Private Chat: Enable private chat among users.
  - Additional Metadata: Provide extra parameters for more detailed class setup.
...
3. How to view recordings
	1. Click on more options (three dots) on the class for which you want to view recording
